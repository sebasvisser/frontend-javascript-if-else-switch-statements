...
// ==========================================
const equalNumbersOne = 10 > 20;
console.log("Is 10 groter dan 20?", equalNumbersOne);
...
// ==========================================
const equalNumbersTwo = 10 !== 11;
console.log("Is 10 ongelijk aan 11?", equalNumbersTwo);

// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const equalWords = "zoet" === "sappig";
console.log("Zijn de woorden zoet en sappig hetzelfde?", equalWords);
